...
export default function Index() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      text: "Привет! Я Ио! 🧚‍♀️ Посмотри на это окошко для разговоров! Здесь ты можешь поболтать со мной, как с лучшим другом. Я спрошу у тебя, для кого мы будем сочинять сказку, как зовут главного героя и о чём он мечтает. А потом — раз! — и на твоих глазах родится настоящее чудо.",
      sender: "bot",
      timestamp: new Date(),
    },
  ]);
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute top-20 left-10 text-3xl animate-fairy-float">
        🧚‍♀️
      </div>
      <div
        className="absolute top-32 right-20 text-2xl animate-fairy-float"
        style={{ animationDelay: "1s" }}
      >
        ✨
      </div>
      <div className="absolute bottom-32 left-20 text-2xl animate-sparkle">
        🌟
      </div>
      <div
        className="absolute top-40 left-1/4 text-2xl animate-fairy-float"
        style={{ animationDelay: "2s" }}
      >
        🦋
      </div>
      <div
        className="absolute bottom-20 right-10 text-3xl animate-sparkle"
        style={{ animationDelay: "0.5s" }}
      >
        🧚‍♂️
      </div>
      <div
        className="absolute top-60 right-1/4 text-xl animate-fairy-float"
        style={{ animationDelay: "1.5s" }}
      >
        🐉
      </div>
      <div
        className="absolute bottom-40 left-1/3 text-2xl animate-sparkle"
        style={{ animationDelay: "2.5s" }}
      >
        🦄
      </div>
      <div
        className="absolute top-80 left-16 text-lg animate-fairy-float"
        style={{ animationDelay: "3s" }}
      >
        🌈
      </div>
      <div
        className="absolute bottom-60 right-20 text-xl animate-sparkle"
          ...
          <div className="flex justify-center items-center gap-6">
            <div className="relative group">
              ...
              <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-4 py-3 bg-white/95 backdrop-blur-sm text-gray-800 text-sm rounded-xl shadow-xl border border-enchanted-purple/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 w-80">
                ...
                <div className="text-xs leading-relaxed">
                  Это твой личный сундучок с сокровищами! Каждая сказка будет
                  бережно храниться здесь. Названия историй — это волшебные
                  дверцы, коснись любой и сказка откроется! Можно отправлять в
                  WhatsApp, Telegram или по почте.
                </div>
              </div>
            </div>
            <div className="relative group">
              <Button className="bg-magical-pink hover:bg-magical-pink/90 text-white font-sans font-semibold text-lg px-6 py-3 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-4 py-3 bg-white/95 backdrop-blur-sm text-gray-800 text-sm rounded-xl shadow-xl border border-magical-pink/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 w-80">
                ...
                <div className="text-xs leading-relaxed">
                  Эта кнопочка — для самого главного волшебства! Открывает дверь
                  в мастерскую добрых книгочеев. Превратите свои любимые истории
                  в настоящую книгу с иллюстрациями на качественной бумаге и
                  твёрдой обложкой!
                </div>
              </div>
            </div>
            <div className="relative group">
              ...
              <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-4 py-3 bg-white/95 backdrop-blur-sm text-gray-800 text-sm rounded-xl shadow-xl border border-fairy-green/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 w-80">
                ...
                <div className="text-xs leading-relaxed">
                  А это — волшебный мостик! Если захочется пообщаться с
              ...
              <div className="flex items-center gap-4 pb-6 border-b-2 border-gray-200">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-600 font-sans">
                    Здравствуй, юный мечтатель! Ты попал в волшебное место, где
                    рождаются самые удивительные истории. Наша «Мастерская
                    сказок» — это сказочный уголок в интернете, где живёт Ио -
                    сказочник. Это добрый дух, который умеет придумывать
                    приключения, и он очень хочет подружиться с тобой!
                  </p>
                </div>
              </div>
